...
- [ ] **Bandeau logos « Ils m'ont fait confiance »** : bandeau défilant implémenté dans `index.html` (composant piloté par `trustedByData`, comme `projectsData`), avec 3 logos sur 5 (Printemps des Arts, Fondation Princesse Charlène de Monaco, Musée Océanographique de Monaco). Reste à faire : ajouter les logos L'Èze Harmonies et Explore Nice Côte d'Azur (+ Audiovista, March on Mars plus tard) ; fournir le lien externe du Musée Océanographique (affiché sans lien pour l'instant) ; confirmer si Printemps des Arts / FPCM doivent pointer vers `#projets` (choix actuel) ou vers leurs sites externes.
